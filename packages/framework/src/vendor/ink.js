!((t, e) => {
  ...
  class e {
    ...
    get tail() {
      if (this._components.length >= 2) {
        const t = this._components.slice(1, this._components.length);
        return new e(t);
      }
      return e.self;
    }
    ...
    get lastComponent() {
      const t = this._components.length - 1;
    ...
    set componentsString(t) {
      ...
      const n = this._componentsString.split('.');
      for (const t of n)
        /^(-|\+)?([0-9]+|Infinity)$/.test(t)
          ? this._components.push(new e.Component(parseInt(t, 10)))
  ...
  (e.parentId = '^'),
    ...
    ((t) => {
      function e(t, e) {
        if (!t)
          throw (
            (void 0 !== e && console.warn(e), console.trace?.(), new Error(''))
          );
      }
      (t.AssertType = (t, n, i) => {
        e(t instanceof n, i);
  ...
  class m {
    ...
    DebugLineNumberOfPath(t) {
      ...
      const e = this.rootContentContainer;
      if (e) {
        const n = e.ContentAtPath(t).obj;
        if (n) {
          const t = n.debugMetadata;
    ...
    ConvertPathToRelative(t) {
      let n = this.path,
        ...
        r = -1;
      for (let e = 0; e < i; ++e) {
        const i = n.GetComponent(e),
          a = t.GetComponent(e);
        if (!i.Equals(a)) break;
        r = e;
      }
      if (-1 === r) return t;
      const a = n.componentCount - 1 - r,
        s = [];
  ...
  class f {
    ...
    AppendFormat(t) {
      for (
        let e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), i = 1;
        i < e;
        i++
      )
        n[i - 1] = arguments[i];
  ...
  class g {
    constructor() {
      if (
        ...
        const t = arguments[0].toString().split('.');
    ...
    static isLikeInkListItem(t) {
      return (
        'object' === typeof t &&
        !(!Object.hasOwn(t, 'originName') || !Object.hasOwn(t, 'itemName')) &&
  ...
  class S extends Map {
    constructor() {
      if (
        ...
        const n = e.listDefinitions.TryListGetDefinition(t, null);
        if (!n.exists)
          throw new Error(
        ...
        Object.hasOwn(arguments[0], 'Key') &&
        Object.hasOwn(arguments[0], 'Value')
      ) {
        const t = arguments[0];
    ...
    static FromString(t, e) {
      ...
      throw new Error(
        `Could not find the InkListItem from the string '${t}' to create an InkList because it doesn't exist in the original list definition in ink.`,
      );
    }
    AddItem(t) {
      if (t instanceof g) {
        ...
        for (const t of this.origins)
          if (t.name === e.originName) {
            const n = t.TryGetValueForItem(e, 0);
            if (n.exists) return void this.Add(e, n.result);
            throw new Error(
              `Could not add the item ${e} to this list because it doesn't exist in the original list definition in ink.`,
            );
          }
        throw new Error(
      ...
      }
      {
        ...
        for (const t of this.origins) {
          ...
          if (t.ContainsItemWithName(e)) {
            if (null != n)
              throw new Error(
                `Could not add the item ${e} to this list because it could come from either ${t.name} or ${n.name}`,
              );
            n = t;
          }
        }
        if (null == n)
          throw new Error(
            `Could not add the item ${e} to this list because it isn't known to any list definitions previously associated with this list.`,
          );
        const i = new g(n.name, e),
          r = n.ValueForItem(i);
        this.Add(i, r);
      }
    }
    ...
    get inverse() {
      ...
      if (null != this.origins)
        for (const e of this.origins)
          for (const [n, i] of e.items) {
            const e = g.fromSerializedKey(n);
    ...
    Intersect(t) {
      const e = new S();
      for (const [n, i] of this) t.has(n) && e.set(n, i);
      return e;
    }
    HasIntersection(t) {
      for (const [e] of this) if (t.has(e)) return !0;
      return !1;
    }
    Without(t) {
      const e = new S(this);
    ...
    Contains(t) {
      ...
      for (const [t] of e) if (!this.has(t)) return !1;
      return !0;
    }
    GreaterThan(t) {
      return (
    ...
    ListWithSubRange(t, e) {
      ...
      for (const t of n) t.Value >= i && t.Value <= r && a.Add(t.Key, t.Value);
      return a;
    }
    Equals(t) {
  ...
  class C extends m {
    static Create(t, n) {
      if (n) {
        ...
        if (n === i.Float && !Number.isNaN(t)) return new T(Number(t));
      }
  ...
  class x extends m {
    ...
    get namedOnlyContent() {
      let t = new Map();
      for (const [e, n] of this.namedContent) {
        const i = l(n, m);
        t.set(e, i);
      }
      for (const e of this.content) {
        const n = o(e);
        n?.hasValidName && t.delete(n.name);
      }
      return 0 === t.size && (t = null), t;
    }
    set namedOnlyContent(t) {
      const e = this.namedOnlyContent;
      if (null != e) for (const [t] of e) this.namedContent.delete(t);
      if (null != t)
        for (const [, e] of t) {
          const t = o(e);
    ...
    AddContent(t) {
      if (Array.isArray(t)) {
        const e = t;
        for (const t of e) this.AddContent(t);
      } else {
        const e = t;
    ...
    TryAddNamedContent(t) {
      const e = o(t);
      e?.hasValidName && this.AddToNamedContentOnly(e);
    }
    ...
    ContentAtPath(t) {
      ...
      let r = this,
        a = this;
      for (let l = e; l < n; ++l) {
        const e = t.GetComponent(l);
        if (null == r) {
          i.approximate = !0;
          break;
        }
        const n = r.ContentWithPathComponent(e);
        if (null == n) {
          i.approximate = !0;
          break;
        }
    ...
    AddContentsOfContainer(t) {
      ...
      for (const e of t.content) (e.parent = this), this.TryAddNamedContent(e);
    }
    ContentWithPathComponent(t) {
      ...
      if (t.isParent) return this.parent;
      {
        ...
        const e = v(this.namedContent, t.name, null);
    ...
    BuildStringOfHierarchy() {
      ...
      const a = new Map();
      for (const [t, e] of this.namedContent)
  ...
  class W extends m {
    get targetPath() {
      if (this._targetPath?.isRelative) {
        const t = this.targetPointer.Resolve();
    ...
    get targetPointer() {
      if (this._targetPointer.isNull) {
        const t = this.ResolvePath(this._targetPath).obj;
  ...
  class V extends m {
    ...
    get pathOnChoice() {
      if (this._pathOnChoice?.isRelative) {
  ...
  class j extends m {
    ...
    static CallExistsWithName(t) {
      return j.GenerateNativeFunctionsIfNecessary(), j._nativeFunctions.get(t);
    }
    get name() {
    ...
    Call(t) {
      ...
      const n = this.CoerceValuesToSingleType(t),
        r = n[0].valueType;
      return r === i.Int ||
        r === i.Float ||
        r === i.String ||
    ...
    CallType(t) {
      ...
      if (2 === a || 1 === a) {
        ...
        const s = this._operationFuncs.get(n);
        if (!s) {
          const t = i[n];
    ...
    CallBinaryListOperation(t) {
      ...
      if (
        ...
        if (null === this._operationFuncs)
          return p('NativeFunctionCall._operationFuncs');
        const t = this._operationFuncs.get(i.Int);
        if (null === t)
      ...
      throw new y(
        `Can not call use ${this.name} operation on ${i[e.valueType]} and ${i[n.valueType]}`,
      );
    }
    CallListIncrementOperation(t) {
      ...
      for (const [t, a] of e.value) {
        const s = g.fromSerializedKey(t);
        if (null === this._operationFuncs)
          return p('NativeFunctionCall._operationFuncs');
        const l = this._operationFuncs.get(i.Int);
        if (null === n.value)
          return p(
        ...
        for (const t of e.value.origins)
          if (t.name === s.originName) {
            h = t;
            break;
          }
        if (null != h) {
          const t = h.TryGetItemWithValue(o, g.Null);
      ...
      if (i[e] === i[i.List])
        for (const e of t) {
          ...
          if (t.valueType === i.List) r.push(t);
            ...
            {
              const e = parseInt(t.valueObject, 10);
              if (((n = l(n, O)), null === n.value))
                return p(
                  'NativeFunctionCall.CoerceValuesToSingleType specialCaseList.value',
                );
              const i = n.value.originOfMaxItem;
              if (null === i)
                return p('NativeFunctionCall.CoerceValuesToSingleType list');
              const a = i.TryGetItemWithValue(e, g.Null);
              if (!a.exists)
                throw new y(
                  `Could not find List item with the value ${e} in ${i.name}`,
                );
              {
                const t = new O(a.result, e);
                r.push(t);
              }
            }
          }
    ...
    static GenerateNativeFunctionsIfNecessary() {
      if (null == j._nativeFunctions) {
        (j._nativeFunctions = new Map()),
          j.AddIntBinaryOp(j.Add, (t, e) => t + e),
          j.AddIntBinaryOp(j.Subtract, (t, e) => t - e),
          j.AddIntBinaryOp(j.Multiply, (t, e) => t * e),
          j.AddIntBinaryOp(j.Divide, (t, e) => Math.floor(t / e)),
          j.AddIntBinaryOp(j.Mod, (t, e) => t % e),
          j.AddIntUnaryOp(j.Negate, (t) => -t),
          j.AddIntBinaryOp(j.Equal, (t, e) => t === e),
          j.AddIntBinaryOp(j.Greater, (t, e) => t > e),
          j.AddIntBinaryOp(j.Less, (t, e) => t < e),
          j.AddIntBinaryOp(j.GreaterThanOrEquals, (t, e) => t >= e),
          j.AddIntBinaryOp(j.LessThanOrEquals, (t, e) => t <= e),
          j.AddIntBinaryOp(j.NotEquals, (t, e) => t !== e),
          j.AddIntUnaryOp(j.Not, (t) => 0 === t),
          j.AddIntBinaryOp(j.And, (t, e) => 0 !== t && 0 !== e),
          j.AddIntBinaryOp(j.Or, (t, e) => 0 !== t || 0 !== e),
          j.AddIntBinaryOp(j.Max, (t, e) => Math.max(t, e)),
          j.AddIntBinaryOp(j.Min, (t, e) => Math.min(t, e)),
          j.AddIntBinaryOp(j.Pow, (t, e) => t ** e),
          j.AddIntUnaryOp(j.Floor, j.Identity),
          j.AddIntUnaryOp(j.Ceiling, j.Identity),
          j.AddIntUnaryOp(j.Int, j.Identity),
          j.AddIntUnaryOp(j.Float, (t) => t),
          j.AddFloatBinaryOp(j.Add, (t, e) => t + e),
          j.AddFloatBinaryOp(j.Subtract, (t, e) => t - e),
          j.AddFloatBinaryOp(j.Multiply, (t, e) => t * e),
          j.AddFloatBinaryOp(j.Divide, (t, e) => t / e),
          j.AddFloatBinaryOp(j.Mod, (t, e) => t % e),
          j.AddFloatUnaryOp(j.Negate, (t) => -t),
          j.AddFloatBinaryOp(j.Equal, (t, e) => t === e),
          j.AddFloatBinaryOp(j.Greater, (t, e) => t > e),
          j.AddFloatBinaryOp(j.Less, (t, e) => t < e),
          j.AddFloatBinaryOp(j.GreaterThanOrEquals, (t, e) => t >= e),
          j.AddFloatBinaryOp(j.LessThanOrEquals, (t, e) => t <= e),
          j.AddFloatBinaryOp(j.NotEquals, (t, e) => t !== e),
          j.AddFloatUnaryOp(j.Not, (t) => 0 === t),
          j.AddFloatBinaryOp(j.And, (t, e) => 0 !== t && 0 !== e),
          j.AddFloatBinaryOp(j.Or, (t, e) => 0 !== t || 0 !== e),
          j.AddFloatBinaryOp(j.Max, (t, e) => Math.max(t, e)),
          j.AddFloatBinaryOp(j.Min, (t, e) => Math.min(t, e)),
          j.AddFloatBinaryOp(j.Pow, (t, e) => t ** e),
          j.AddFloatUnaryOp(j.Floor, (t) => Math.floor(t)),
          j.AddFloatUnaryOp(j.Ceiling, (t) => Math.ceil(t)),
          j.AddFloatUnaryOp(j.Int, (t) => Math.floor(t)),
          j.AddFloatUnaryOp(j.Float, j.Identity),
          j.AddStringBinaryOp(j.Add, (t, e) => t + e),
          j.AddStringBinaryOp(j.Equal, (t, e) => t === e),
          j.AddStringBinaryOp(j.NotEquals, (t, e) => !(t === e)),
          j.AddStringBinaryOp(j.Has, (t, e) => t.includes(e)),
          j.AddStringBinaryOp(j.Hasnt, (t, e) => !t.includes(e)),
          j.AddListBinaryOp(j.Add, (t, e) => t.Union(e)),
          j.AddListBinaryOp(j.Subtract, (t, e) => t.Without(e)),
          j.AddListBinaryOp(j.Has, (t, e) => t.Contains(e)),
          j.AddListBinaryOp(j.Hasnt, (t, e) => !t.Contains(e)),
          j.AddListBinaryOp(j.Intersect, (t, e) => t.Intersect(e)),
          j.AddListBinaryOp(j.Equal, (t, e) => t.Equals(e)),
          j.AddListBinaryOp(j.Greater, (t, e) => t.GreaterThan(e)),
          j.AddListBinaryOp(j.Less, (t, e) => t.LessThan(e)),
          j.AddListBinaryOp(j.GreaterThanOrEquals, (t, e) =>
            t.GreaterThanOrEquals(e),
          ),
          j.AddListBinaryOp(j.LessThanOrEquals, (t, e) =>
            t.LessThanOrEquals(e),
          ),
          j.AddListBinaryOp(j.NotEquals, (t, e) => !t.Equals(e)),
          j.AddListBinaryOp(j.And, (t, e) => t.Count > 0 && e.Count > 0),
          j.AddListBinaryOp(j.Or, (t, e) => t.Count > 0 || e.Count > 0),
          j.AddListUnaryOp(j.Not, (t) => (0 === t.Count ? 1 : 0)),
          j.AddListUnaryOp(j.Invert, (t) => t.inverse),
          j.AddListUnaryOp(j.All, (t) => t.all),
          j.AddListUnaryOp(j.ListMin, (t) => t.MinAsList()),
          j.AddListUnaryOp(j.ListMax, (t) => t.MaxAsList()),
          j.AddListUnaryOp(j.Count, (t) => t.Count),
          j.AddListUnaryOp(j.ValueOfList, (t) => t.maxItem.Value);
        const t = (t, e) => t.Equals(e),
          e = (t, e) => !t.Equals(e);
        j.AddOpToNativeFunc(j.Equal, 2, i.DivertTarget, t),
          j.AddOpToNativeFunc(j.NotEquals, 2, i.DivertTarget, e);
      }
    }
    ...
    static AddOpToNativeFunc(t, e, n, i) {
      ...
      let r = j._nativeFunctions.get(t);
      r || ((r = new j(t, e)), j._nativeFunctions.set(t, r)),
        r.AddOpFuncForType(n, i);
    }
    static AddIntBinaryOp(t, e) {
      j.AddOpToNativeFunc(t, 2, i.Int, e);
    }
    static AddIntUnaryOp(t, e) {
      j.AddOpToNativeFunc(t, 1, i.Int, e);
    }
    static AddFloatBinaryOp(t, e) {
      j.AddOpToNativeFunc(t, 2, i.Float, e);
    }
    static AddFloatUnaryOp(t, e) {
      j.AddOpToNativeFunc(t, 1, i.Float, e);
    }
    static AddStringBinaryOp(t, e) {
      j.AddOpToNativeFunc(t, 2, i.String, e);
    }
    static AddListBinaryOp(t, e) {
      j.AddOpToNativeFunc(t, 2, i.List, e);
    }
    static AddListUnaryOp(t, e) {
      j.AddOpToNativeFunc(t, 1, i.List, e);
    }
    toString() {
  ...
  class M {
    ...
    get items() {
      if (null == this._items) {
        this._items = new Map();
        for (const [t, e] of this._itemNameToValues) {
          const n = new g(this.name, t);
    ...
    ValueForItem(t) {
      ...
      const e = this._itemNameToValues.get(t.itemName);
      return void 0 !== e ? e : 0;
    }
    ContainsItem(t) {
      return (
    ...
    TryGetItemWithValue(t, _e) {
      for (const [e, n] of this._itemNameToValues)
        if (n === t) return { result: new g(this.name, e), exists: !0 };
      return { result: g.Null, exists: !1 };
    }
    TryGetValueForItem(t, _e) {
      if (!t.itemName) return { result: 0, exists: !1 };
      const n = this._itemNameToValues.get(t.itemName);
  ...
  class q {
    ...
    static WriteDictionaryRuntimeObjs(t, e) {
      ...
      for (const [n, i] of e)
        t.WritePropertyStart(n),
          q.WriteRuntimeObject(t, i),
          t.WritePropertyEnd();
      t.WriteObjectEnd();
    }
    static WriteListRuntimeObjs(t, e) {
      t.WriteArrayStart();
      for (const n of e) q.WriteRuntimeObject(t, n);
      t.WriteArrayEnd();
    }
    static WriteIntDictionary(t, e) {
      t.WriteObjectStart();
      for (const [n, i] of e) t.WriteIntProperty(n, i);
      t.WriteObjectEnd();
    }
    static WriteRuntimeObject(t, e) {
      const n = s(e, x);
      if (n) return void q.WriteRuntimeContainer(t, n);
      const i = s(e, W);
      if (i) {
        let e,
          n = '->';
      ...
      if (u)
        return void (u.isNewline
          ...
          : (t.WriteStringStart(),
            ...
            t.WriteStringEnd()));
      const c = s(e, O);
      if (c) return void q.WriteInkList(t, c);
      const d = s(e, P);
      if (d)
        return (
          t.WriteObjectStart(),
    ...
    static JObjectToDictionaryRuntimeObjs(t) {
      ...
      for (const n in t)
        if (Object.hasOwn(t, n)) {
          const i = q.JTokenToRuntimeObject(t[n]);
    ...
    static JObjectToIntDictionary(t) {
      const e = new Map();
      for (const n in t) Object.hasOwn(t, n) && e.set(n, parseInt(t[n], 10));
      return e;
    }
    static JTokenToRuntimeObject(t) {
      if (('number' === typeof t && !Number.isNaN(t)) || 'boolean' === typeof t)
        return b.Create(t);
      if ('string' === typeof t) {
        let e = t.toString(),
          n = e[0];
      ...
      if ('object' === typeof t && !Array.isArray(t)) {
        ...
        if (i['^var']) {
          n = i['^var'];
          const t = new N(n.toString());
          return (
            'ci' in i && ((n = i.ci), (t.contextIndex = parseInt(n, 10))), t
          );
        }
        let a = !1,
          s = !1,
        ...
        if (
          ...
          return (
            ...
            (t.isConditional = !!i.c),
            o && (n = i.exArgs) && (t.externalArgs = parseInt(n, 10)),
            t
          );
        }
        if ((n = i['*'])) {
        ...
        if (null != i.originalChoicePath) return q.JObjectToChoice(i);
      }
      if (Array.isArray(t)) return q.JArrayToContainer(t);
      if (null == t) return null;
      throw new Error(
        `Failed to convert token to runtime object: ${q.toJson(t, ['parent'])}`,
      );
    }
    static toJson(t, e, n) {
      return JSON.stringify(
    ...
    static WriteRuntimeContainer(t, e) {
      ...
      for (const n of e.content) q.WriteRuntimeObject(t, n);
      const i = e.namedOnlyContent,
        r = e.countFlags,
        a = null != e.name && !n,
        l = null != i || r > 0 || a;
    ...
    static JArrayToContainer(t) {
      const e = new x();
      e.content = q.JArrayToRuntimeObjList(t, !0);
      const n = t[t.length - 1];
      if (null != n) {
        const t = new Map();
        for (const i in n)
          if ('#f' === i) e.countFlags = parseInt(n[i], 10);
          else if ('#n' === i) e.name = n[i].toString();
          else {
            const e = q.JTokenToRuntimeObject(n[i]),
              r = s(e, x);
    ...
    static JObjectToChoice(t) {
      ...
      return (
        ...
        (e.originalThreadIndex = parseInt(t.originalThreadIndex, 10)),
    ...
    static WriteInkList(t, e) {
      ...
      if (
        ...
        for (const e of n.originNames) t.Write(e);
  ...
  class U {
    ...
    get currentElement() {
      const t = this._threads[this._threads.length - 1].callstack;
      return t[t.length - 1];
    }
    ...
    constructor() {
      if (
        ...
        const t = arguments[0];
        this._threads = [];
        for (const e of t._threads) this._threads.push(e.Copy());
    ...
    PushThread() {
      const t = this.currentThread.Copy();
      this._threadCounter++,
    ...
    GetTemporaryVariableWithName(t) {
      ...
      const n = v(this.callStack[e - 1].temporaryVariables, t, null);
    ...
    ThreadWithIndex(t) {
      const e = this._threads.filter((e) => {
      ...
      for (let e = 0; e < this._threads.length; e++) {
        ...
        for (let e = 0; e < n.callstack.length; e++) {
          n.callstack[e].type === r.Function
            ? t.Append('  [FUNCTION] ')
            : t.Append('  [TUNNEL] ');
          const i = n.callstack[e].currentPointer;
          if (!i.isNull) {
    ...
    class i {
      constructor() {
        if (
          ...
          const t = arguments[0],
            i = arguments[1];
          this.threadIndex = parseInt(t.threadIndex, 10);
          const r = t.callstack;
          for (const t of r) {
            let r,
              a = t,
              s = parseInt(a.type, 10),
              l = F.Null,
              o = a.cPath;
            if (void 0 !== o) {
              r = o.toString();
              const t = i.ContentAtPath(new e(r));
              if (
                ((l.container = t.container),
                (l.index = parseInt(a.idx, 10)),
                null == t.obj)
              )
                throw new Error(
                  `When loading state, internal story location couldn't be found: ${r}. Has the story changed since this save data was created?`,
                );
              if (t.approximate) {
                if (null === l.container) return p('pointer.container');
                i.Warning(
                  `When loading state, exact internal story location couldn't be found: '${r}', so it was approximated to '${l.container.path.toString()}' to recover. Has the story changed since this save data was created?`,
                );
              }
            }
            const h = !!a.exp,
          ...
          const a = t.previousContentObject;
          if (void 0 !== a) {
            const t = new e(a.toString());
      ...
      Copy() {
        ...
        for (const e of this.callstack) t.callstack.push(e.Copy());
      ...
      WriteJson(t) {
        ...
        if (
          ...
          const e = this.previousPointer.Resolve();
  ...
  class K extends class {} {
    variableChangedEvent(t, e) {
      for (const n of this.variableChangedEventCallbacks) n(t, e);
    }
    ...
    set batchObservingVariableChanges(t) {
      if (((this._batchObservingVariableChanges = t), t))
        ...
        for (const t of this._changedVariablesForBatchObs) {
          const e = this._globalVariables.get(t);
    ...
    ApplyPatch() {
      ...
      for (const [t, e] of this.patch.globals) this._globalVariables.set(t, e);
      if (null !== this._changedVariablesForBatchObs)
        for (const t of this.patch.changedVariables)
          this._changedVariablesForBatchObs.add(t);
      this.patch = null;
    }
    SetJsonToken(t) {
      this._globalVariables.clear();
      for (const [e, n] of this._defaultGlobalVariables) {
        const i = t[e];
        if (void 0 !== i) {
          const t = q.JTokenToRuntimeObject(i);
    ...
    WriteJson(t) {
      t.WriteObjectStart();
      for (const [e, n] of this._globalVariables) {
        const i = e,
          r = n;
        if (K.dontSaveDefaultValues && this._defaultGlobalVariables.has(i)) {
          const t = this._defaultGlobalVariables.get(i);
    ...
    TryGetDefaultVariableValue(t) {
      const e = v(this._defaultGlobalVariables, t, null);
      return e.exists ? e.result : null;
    }
    GlobalVariableExistsWithName(t) {
      return (
        this._globalVariables.has(t) || this._defaultGlobalVariables?.has(t)
      );
    }
    GetRawVariableWithName(t, e) {
      ...
      if (0 === e || -1 === e) {
        ...
        const n = this._listDefsOrigin.FindSingleItemListWithName(t);
        if (n) return n;
      }
    ...
    ResolveVariablePointer(t) {
      ...
      const n = s(this.GetRawVariableWithName(t.variableName, e), N);
    ...
    class e {
      ...
      WriteObjectStart() {
        ...
        if (this.state === t.Writer.State.Property) {
          ...
          const t = this._propertyNameStack.pop();
  ...
  class X {
    ...
    WriteJson(t) {
      ...
      let e = !1;
      for (const n of this.currentChoices) {
      ...
      e && (t.WriteObjectEnd(), t.WritePropertyEnd()),
        t.WriteProperty('currentChoices', (t) => {
          t.WriteArrayStart();
          for (const e of this.currentChoices) q.WriteChoice(t, e);
          t.WriteArrayEnd();
        }),
        t.WriteObjectEnd();
    }
    LoadFlowChoiceThreads(t, e) {
      for (const n of this.currentChoices) {
        const i = this.callStack.ThreadWithIndex(n.originalThreadIndex);
        if (null !== i) n.threadAtGeneration = i.Copy();
        else {
          const i = t[`${n.originalThreadIndex}`];
  ...
  class Y {
    ...
    LoadJson(t) {
      const e = $.TextToDictionary(t);
      this.LoadJsonObj(e), this.onDidLoadState?.();
    }
    VisitCountAtPathString(t) {
      let n;
      if (null !== this._patch) {
        const i = this.story.ContentAtPath(new e(t)).container;
    ...
    VisitCountForContainer(t) {
      ...
      if (!t.visitsShouldBeCounted)
        return (
          this.story.Error(
            `Read count for target (${t.name} - on ${t.debugMetadata}) unknown. The story may need to be compiled with countAllVisits flag (-c).`,
          ),
          0
        );
      if (null !== this._patch) {
        const e = this._patch.TryGetVisitCount(t, 0);
    ...
    TurnsSinceForContainer(t) {
      if (
        (t.turnIndexShouldBeCounted ||
          this.story.Error(
            `TURNS_SINCE() for target (${t.name} - on ${t.debugMetadata}) unknown. The story may need to be compiled with countAllVisits flag (-c).`,
          ),
        null !== this._patch)
      ) {
        const e = this._patch.TryGetTurnIndex(t, 0);
    ...
    get currentText() {
      if (this._outputStreamTextDirty) {
        let t = new f(),
          e = !1;
        for (const n of this.outputStream) {
          const i = s(n, E);
          if (e || null === i) {
            const t = s(n, k);
            null !== t &&
        ...
        for (const n of this.outputStream) {
          ...
          if (null != i) {
            if (i.commandType === k.CommandType.BeginTag) {
              if (t && e.Length > 0) {
                const t = this.CleanOutputWhitespace(e.toString());
    ...
    get aliveFlowNames() {
      if (this._aliveFlowNamesDirty) {
        if (((this._aliveFlowNames = []), null != this._namedFlows))
          for (const t of this._namedFlows.keys())
    ...
    CopyAndStartPatching() {
      ...
      if (
        ...
        for (const [e, n] of this._namedFlows)
    ...
    ApplyAnyPatch() {
      if (null !== this._patch) {
        ...
        for (const [t, e] of this._patch.visitCounts)
          this.ApplyCountChanges(t, e, !0);
        for (const [t, e] of this._patch.turnIndices)
    ...
    LoadJsonObj(t) {
      ...
      if (parseInt(i, 10) < this.kMinCompatibleLoadVersion)
        throw new Error(
          `Ink save format isn't compatible with the current version (saw '${i}', but minimum is ${this.kMinCompatibleLoadVersion}), so can't load.`,
        );
      const r = n.flows;
      if (null != r) {
        const t = r;
      ...
      (this._visitCounts = q.JObjectToIntDictionary(n.visitCounts)),
        ...
        (this.currentTurnIndex = parseInt(n.turnIdx, 10)),
        (this.storySeed = parseInt(n.storySeed, 10)),
        (this.previousRandom = parseInt(n.previousRandom, 10));
    }
    ResetErrors() {
    ...
    PushToOutputStream(t) {
      const e = s(t, E);
      if (null !== e) {
        const t = this.TrySplittingHeadTailWhitespace(e);
        if (null !== t) {
          for (const e of t) this.PushToOutputStreamIndividual(e);
    ...
    TrySplittingHeadTailWhitespace(t) {
      ...
      if (-1 !== n) {
        if (n > 0) {
          const t = new E(e.substring(0, n));
          s.push(t);
        }
        s.push(new E('\n')), (l = i + 1);
      }
      if ((-1 !== r && (o = a), o > l)) {
        const t = e.substring(l, o);
        s.push(new E(t));
      }
      if (-1 !== r && a > i && (s.push(new E('\n')), r < e.length - 1)) {
        const t = e.length - r - 1,
    ...
    PushToOutputStreamIndividual(t) {
      ...
      if (e) this.TrimNewlinesFromOutputStream(), (i = !0);
        ...
        let s = -1;
        if (
          ((s = -1 !== a && -1 !== t ? Math.min(t, a) : -1 !== a ? a : t),
          -1 !== s)
        ) {
          if (n.isNewline) i = !1;
          else if (
            ...
            const t = this.callStack.elements;
    ...
    TrimNewlinesFromOutputStream() {
      ...
      for (; e >= 0; ) {
        const n = this.outputStream[e],
          i = s(n, k),
          r = s(n, E);
        if (null != i || r?.isNonWhitespace) break;
        r?.isNewline && (t = e), e--;
      }
      if (t >= 0)
    ...
    get outputStreamContainsContent() {
      for (const t of this.outputStream) if (t instanceof E) return !0;
      return !1;
    }
    get inStringEvaluation() {
      for (let t = this.outputStream.length - 1; t >= 0; t--) {
        const e = s(this.outputStream[t], k);
    ...
    PushEvaluationStack(t) {
      ...
      if (e) {
        ...
        if (null != t.originNames) {
          ...
          for (const e of t.originNames) {
            if (null === this.story.listDefinitions)
              return p('StoryState.story.listDefinitions');
            const n = this.story.listDefinitions.TryListGetDefinition(e, null);
    ...
    SetChosenPath(t, e) {
      this._currentFlow.currentChoices.length = 0;
      const n = this.story.PointerAtPath(t);
      ...
      if (null !== t)
        for (let e = 0; e < t.length; e++) {
          if (
            ...
            throw new Error(
              `ink arguments when calling EvaluateFunction / ChoosePathStringWithParameters must benumber, string, bool or InkList. Argument was ${null === h(t[e]) ? 'null' : t[e].constructor.name}`,
            );
    ...
    CompleteFunctionEvaluationFromGame() {
      ...
      for (; this.evaluationStack.length > t; ) {
        const t = this.PopEvaluationStack();
        null === e && (e = t);
      }
  ...
  class Z extends m {
    get currentChoices() {
      ...
      for (const e of this._state.currentChoices)
    ...
    ToJson(t) {
      ...
      if (
        ...
        for (const e of this._listDefinitions.lists) {
    ...
    ResetGlobals() {
      if (this._mainContentContainer.namedContent.get('global decl')) {
        const t = this.state.currentPointer.copy();
    ...
    ContinueInternal() {
      ...
      if (
        ...
        if (this.state.hasError)
          for (const t of this.state.currentErrors) this.onError(t, a.Error);
        if (this.state.hasWarning)
          for (const t of this.state.currentWarnings)
    ...
    ContinueSingleStep() {
      if (
        ...
        if (null !== this._stateSnapshotAtLastNewline) {
          ...
          const t = this.CalculateNewlineOutputStateChange(
      ...
      return this._profiler?.PostSnapshot(), !1;
    }
    ...
    KnotContainerWithName(t) {
      const e = this.mainContentContainer.namedContent.get(t);
      ...
      return null === t.lastComponent
        ...
        : (t.lastComponent.isIndex
          ...
          null == i.obj || (i.obj === this.mainContentContainer && n > 0)
            ? this.Error(
                `Failed to find content at path '${t}', and no approximation of it was possible.`,
              )
            : i.approximate &&
              this.Warning(
                `Failed to find content at path '${t}', so it was approximated to: '${i.obj.path}'.`,
              ),
          e);
    }
    StateSnapshot() {
    ...
    VisitChangedContainersDueToDivert() {
      const t = this.state.previousPointer.copy(),
        e = this.state.currentPointer.copy();
    ...
    ProcessChoice(t) {
      let e = !0;
      if (t.hasCondition) {
        const t = this.state.PopEvaluationStack();
        this.IsTruthy(t) || (e = !1);
      }
      let n = '',
        i = '',
    ...
    IsTruthy(t) {
      if (t instanceof b) {
        ...
        if (e instanceof P) {
          ...
          return (
            this.Error(
              `Shouldn't use a divert target (to ${t.targetPath}) as a conditional value. Did you intend a function call 'likeThis()' or a read count check 'likeThis'? (no arrows)`,
            ),
            !1
          );
        }
        ...
        switch (e.commandType) {
          ...
          case k.CommandType.PopTunnel: {
            ...
            if (
              ...
              const i = `Found ${e.get(t)}, when expected ${n}`;
              this.Error(i);
            }
            break;
          }
          ...
          case k.CommandType.EndTag:
            if (this.state.inStringEvaluation) {
              ...
              for (let n = this.state.outputStream.length - 1; n >= 0; --n) {
                const i = this.state.outputStream[n];
                e++;
                const r = s(i, k);
                if (null != r) {
              ...
              const n = new f();
              for (const e of t.reverse()) n.Append(e.toString());
              const i = new B(this.state.CleanOutputWhitespace(n.toString()));
              this.state.PushEvaluationStack(i);
          ...
          case k.CommandType.EndString: {
            ...
            for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
              const r = this.state.outputStream[i];
              n++;
              const a = s(r, k);
            ...
            for (const t of e) this.state.PushToOutputStream(t);
            t = t.reverse();
            const i = new f();
            for (const e of t) i.Append(e.toString());
            (this.state.inExpressionEvaluation = !0),
              this.state.PushEvaluationStack(new E(i.toString()));
            break;
          }
          case k.CommandType.ChoiceCount: {
            const i = this.state.generatedChoices.length;
          ...
          case k.CommandType.ReadCount: {
            ...
            if (!(a instanceof P)) {
              ...
              a instanceof w &&
                ...
                this.Error(
                  `TURNS_SINCE / READ_COUNT expected a divert target (knot, stitch, label name), but saw ${a}${t}`,
                );
              break;
            }
            let o,
            ...
            null != u
              ...
              : ((o = e.commandType === k.CommandType.TurnsSince ? -1 : 0),
                this.Warning(
                  `Failed to find container for ${e.toString()} lookup at ${h.targetPath.toString()}`,
                )),
              this.state.PushEvaluationStack(new w(o));
            break;
          }
          case k.CommandType.Random: {
            const t = s(this.state.PopEvaluationStack(), w),
            ...
            (!Number.isFinite(n) || n > Number.MAX_SAFE_INTEGER) &&
              ...
              n <= 0 &&
                this.Error(
                  `RANDOM was called with minimum as ${e.value} and maximum as ${t.value}. The maximum must be larger`,
                );
            const i = this.state.storySeed + this.state.previousRandom,
              r = new z(i).next(),
              a = (r % n) + e.value;
          ...
          case k.CommandType.SeedRandom: {
            const c = s(this.state.PopEvaluationStack(), w);
          ...
          case k.CommandType.SequenceShuffleIndex: {
            const m = this.NextSequenceShuffleIndex();
          ...
          case k.CommandType.ListFromInt: {
            const v = s(this.state.PopEvaluationStack(), w),
            ...
            const T = this.listDefinitions.TryListGetDefinition(C.value, null);
            if (!T.exists) throw new y(`Failed to find LIST called ${C.value}`);
            {
              if (null === v.value) return p('minInt.value');
              const t = T.result.TryGetItemWithValue(v.value, g.Null);
          ...
          case k.CommandType.ListRange: {
            const N = s(this.state.PopEvaluationStack(), b),
            ...
            const W = I.value.ListWithSubRange(A.valueObject, N.valueObject);
          ...
          case k.CommandType.ListRandom: {
            ...
            if (0 === e.Count) n = new S();
              ...
              const t = this.state.storySeed + this.state.previousRandom,
                i = new z(t).next(),
                r = i % e.Count,
                a = e.entries();
      ...
      if (t instanceof L) {
        ...
        if (null != e.pathForCount) {
          ...
          (n = this.state.variablesState.GetVariableWithName(e.name)),
            null == n &&
              (this.Warning(
                `Variable not found: '${e.name}'. Using default value of 0 (false). This can happen with temporary variables if the declaration hasn't yet been hit. Globals are always given a default value on load if a value doesn't exist in the save state.`,
              ),
              (n = new w(0)));
    ...
    ChoosePathString(t) {
      ...
      if (
        ...
        throw (
          ...
          new Error(
            `Story was running a function ${e}when you called ChoosePathString(${t}) - this is almost certainly not not what you want! Full stack trace: \n${this.state.callStack.callStackTrace}`,
          ))
        );
      }
    ...
    IfAsyncWeCant(t) {
      if (this._asyncContinueActive)
        throw new Error(
          `Can't ${t}. Story is in the middle of a ContinueAsync(). Make more ContinueAsync() calls or a single Continue() call beforehand.`,
        );
    }
    ChoosePath(t) {
      const e =
    ...
    EvaluateFunction(t) {
      ...
      const i = this.KnotContainerWithName(t);
      ...
      const l = this.state.CompleteFunctionEvaluationFromGame();
      return (
    ...
    EvaluateExpression(t) {
      const e = this.state.callStack.elements.length;
      this.state.callStack.Push(r.Tunnel),
        (this._temporaryEvaluationContainer = t),
        this.state.GoToStart();
      const n = this.state.evaluationStack.length;
      return (
        this.Continue(),
        (this._temporaryEvaluationContainer = null),
      ...
      if (!a) {
        if (this.allowExternalFunctionFallbacks)
          return (
            ...
            this.Assert(
              null !== i,
              `Trying to call EXTERNAL function '${t}' which has not been bound, and fallback ink function could not be found.`,
            ),
            this.state.callStack.Push(
              r.Function,
              void 0,
        ...
        this.Assert(
          !1,
          `Trying to call EXTERNAL function '${t}' which has not been bound (and ink fallbacks disabled).`,
        );
      }
      const s = [];
      for (let t = 0; t < e; ++t) {
        const t = l(this.state.PopEvaluationStack(), b).valueObject;
        s.push(t);
      }
      s.reverse();
      let o = n.function(s),
    ...
    ValidateExternalBindings() {
      ...
      if (
        ...
        for (const e of t.content) {
          e?.hasValidName || this.ValidateExternalBindings(e, n);
        }
        for (const [, e] of t.namedContent)
          this.ValidateExternalBindings(s(e, m), n);
      } else if (null != e) {
        const t = s(e, W);
        if (t?.isExternal) {
          const e = t.targetPathString;
      ...
      if (
        ...
        if (null != e) {
          if (this._variableObservers.has(e))
            if (null != t) {
              const n = this._variableObservers.get(e);
              null != n &&
                (n.splice(n.indexOf(t), 1),
                0 === n.length && this._variableObservers.delete(e));
            } else this._variableObservers.delete(e);
        } else if (null != t) {
          const e = this._variableObservers.keys();
          for (const n of e) {
            const e = this._variableObservers.get(n);
            null != e &&
    ...
    VariableStateDidChangeEvent(t, e) {
      ...
      const n = this._variableObservers.get(t);
      if (void 0 !== n) {
        if (!(e instanceof b))
          throw new Error(
        ...
        const i = l(e, b);
        for (const e of n) e(t, i.valueObject);
      }
    }
    get globalTags() {
    ...
    IncrementContentPointer() {
      ...
      for (; e.index >= e.container.content.length; ) {
        t = !1;
        const n = s(e.container.parent, x);
        if (n instanceof x === !1) break;
        const i = n.content.indexOf(e.container);
        if (-1 === i) break;
    ...
    TryFollowDefaultInvisibleChoice() {
      const t = this._state.currentChoices,
    ...
    NextSequenceShuffleIndex() {
      ...
      const e = this.state.currentPointer.container;
      ...
      const u = h + r + this.state.storySeed,
        c = new z(Math.floor(u)),
        d = [];
      for (let t = 0; t < n; ++t) d.push(t);
      for (let t = 0; t <= a; ++t) {
        const e = c.next() % d.length,
          n = d[e];
    ...
    AddError(t) {
      const e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
        ...
        r = e ? 'WARNING' : 'ERROR';
      if (null != i) {
        const e = n ? i.endLineNumber : i.startLineNumber;
